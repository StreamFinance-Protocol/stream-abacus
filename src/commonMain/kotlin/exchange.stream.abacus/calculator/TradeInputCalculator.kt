...
import abs
import exchange.stream.abacus.calculator.SlippageConstants.MAJOR_MARKETS
import exchange.stream.abacus.calculator.SlippageConstants.MARKET_ORDER_MAX_SLIPPAGE
import exchange.stream.abacus.calculator.SlippageConstants.SLIPPAGE_STEP_SIZE
import exchange.stream.abacus.calculator.SlippageConstants.STOP_MARKET_ORDER_SLIPPAGE_BUFFER
import exchange.stream.abacus.calculator.SlippageConstants.STOP_MARKET_ORDER_SLIPPAGE_BUFFER_MAJOR_MARKET
import exchange.stream.abacus.calculator.SlippageConstants.TAKE_PROFIT_MARKET_ORDER_SLIPPAGE_BUFFER
import exchange.stream.abacus.calculator.SlippageConstants.TAKE_PROFIT_MARKET_ORDER_SLIPPAGE_BUFFER_MAJOR_MARKET
...
internal class TradeInputCalculator(
    ...
    internal fun calculate(
        ...
        return if (trade != null && type != null) {
            ...
            val trade = if (input != null) {
                ...
                finalize(trade, account, subaccount, user, market, feeTiers, type)
            }
    ...
    private fun finalize(
        ...
        modified.safeSet(
            "summary",
            summaryForType(trade, subaccount, user, market, feeTiers, type),
        )
