...
internal fun AccountSupervisor.swap(data: String?, type: SwapInputField?) {
    subaccount?.swap(data, type)
}

internal fun AccountSupervisor.changeSwapDirection() {
    subaccount?.changeSwapDirection()
}
